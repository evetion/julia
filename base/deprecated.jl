...
function cumsum_kbn(v::AbstractVector{T}) where T<:AbstractFloat
    depwarn(string("`cumsum_kbn` is discontinued. Use `cumsum` instead for a typically ",
                   "faster and more memory efficient cumulative summation, with a small ",
                   "decrease in accuracy compared to the Kahan-Babuska-Neumaier compensated ",
                   "summation algorithm."), :cumsum_kbn)
    r = similar(v)
...
function sum_kbn(A)
    depwarn(string("`sum_kbn` is discontinued. Use `sum` instead for a typically faster ",
                   "and more memory efficient summation, with a small decrease in accuracy ",
                   "compared to the Kahan-Babuska-Neumaier compensated summation ",
                   "algorithm."), :sum_kbn)
